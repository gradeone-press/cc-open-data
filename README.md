...
| `gaps.csv` / `.json` | 136 | Every question the book could not answer at the grade it requires |
...
exists and nobody has compiled it. 26 are closeable. Of the 136,
88 come from the career profiles and 48 are declared
